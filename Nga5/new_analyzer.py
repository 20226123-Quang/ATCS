...
def analyze_all_data_kpis(folder_path="."):
    ...
    all_files = glob.glob(os.path.join(folder_path, "*_*_test_nga5.csv"))
    ...
    summary_df.to_csv("debug_in_nga5.csv", index=False)
    print("[*] Đã lưu báo cáo đầy đủ tại: all_records_nga5.csv")
